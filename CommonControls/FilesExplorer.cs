...
namespace CommonControls
{
    public partial class FilesExplorer : TreeView
    {
        ...
        private List<FileEditor> fileEditors = new List<FileEditor>();
        ...
        /// <summary>
        /// List of FileEditors controls, used to open files of this explorer
        /// </summary>
        [
            Category("Explorer"),
            Description("List of FileEditors controls, used to open files of this explorer")]
        public FileEditor[] FileEditors { get => fileEditors.ToArray(); set => fileEditors = value.ToList(); }
        ...
        public void SetWorkspace(ref Workspace workspace)
        {
        ...
        private void FilesExplorer_NodeMouseDoubleClick(object sender, TreeNodeMouseClickEventArgs e)
        {
