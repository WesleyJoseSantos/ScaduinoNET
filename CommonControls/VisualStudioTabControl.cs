...
namespace VisualStudioTabControl
{
    ...
    public class VisualStudioTabControl : TabControl
    {
        ...
        /// </summary>
        public Color customSelectedTextColor = Color.FromArgb(255, 255, 255);
        /// <summary>
        ///     Init
        /// </summary>
        ...
        public Color SelectedTextColor
        {
            get
            {
                return this.customSelectedTextColor;
            }

            set
            {
                this.customSelectedTextColor = value;
            }
        }
                    ...
                    for (var i = 0; i < this.TabCount; i++)
                    {
                        ...
                        if (this.ShowClosingMessage)
                        {
                            if (DialogResult.Yes == MessageBox.Show(this.ClosingMessage, "Close", MessageBoxButtons.YesNo))
                            {
                                ...
                                {
                                    var args = new CloseButtonClickedEventArgs { TabPage = this.TabPages[i] };
            ...
            for (var i = 0; i <= TabCount - 1; i++)
            {
                ...
                if (i == SelectedIndex)
                {
                    ...
                    Drawer.DrawString(
                        TabPages[i].Text,
                        Font,
                        new SolidBrush(this.customSelectedTextColor),
                        HeaderSize,
